...
<p align="center">
  <strong>Enterprise-grade UI test automation framework built to validate critical e-commerce Search and Cart workflows on the LambdaTest eCommerce Playground platform.</strong>
</p>
...
│   └── Automation_Project_Presentation.pdf  # Project showcase & presentation slide deck
├── src/
